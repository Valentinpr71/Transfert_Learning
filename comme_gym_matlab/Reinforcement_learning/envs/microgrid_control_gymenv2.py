...
class microgrid_control_gym(gym.Env):
    ...
    def __init__(self, data='train', plot_every=10, ppc=None, sell_to_grid=False,hydrogene_storage_penalty=False, total_timesteps=8760*10,month=[]):#,month=[9,10,11,12,1,2]):
