...
if __name__=="__main__":
    ...
    model=DQN(CustomDQNPolicy, env, verbose=1,  exploration_final_eps=0.01, exploration_fraction=0.000023,target_network_update_freq=1095, buffer_size=1000000, batch_size=264, learning_rate=0.02)
