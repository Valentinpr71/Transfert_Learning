...
if __name__ == "__main__":
    ...
    for i in range(dim_num_iteration):
        ...
        cheat_dim_list = [np.array([9.,6.]), np.array([4.,4.]),np.array([5.0, 5.0]),np.array([7.0,8.0]),np.array([9.0,5.0])] #Ajouté uniquement dans un but d'analyse de l'algo au début (on force le nb de voisin a etre petit)
