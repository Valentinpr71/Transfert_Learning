...
class Test_plot():
    def __init__(self, info, num_episode, hydrogene_storage_penality, ppc, sell_grid):
    ...
    def plot_rewards(self):
        ...
        plt.suptitle(self.hydrogene_storage_penality+self.ppc+self.sell_grid)
        ax=plt.gca()
    ...
    def save(self):
        ...
        plt.text(x=0.5, y=0.85, s='Episode '+str(self.num_episode)+'\n'+self.hydrogene_storage_penality+self.ppc+self.sell_grid, fontsize=18, ha="center", transform=fig.transFigure)
